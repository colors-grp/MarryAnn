        ...
        //Get all card games then select only the 1st game
            ...
            if(count($games) > 0 ){
                ...
                if(count($info) > 0){
                    $bg_width = 600;
                    $bg_height = 339;
                    $y_difference = 290;//-290px zero point
                    $data['x'] = ($bg_height + $info[0]['top']) / $bg_height;
                    $data['y'] = ($y_difference + $info[0]['left']) / $bg_width;
                    $data['width'] = $info[0]['width'] / $bg_width;
