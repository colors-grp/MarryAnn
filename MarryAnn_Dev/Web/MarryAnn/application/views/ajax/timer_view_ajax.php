...
?>
﻿ <table id="header_counter" style = "visibility: hidden;">
    <tr>
            <td>
                    <div class="clock-item clock-days countdown-time-value" style = "width: 75px;">
                            <div class="wrap">
                                    <div class="inner">
            ...
            <td>
                    <div class="clock-item clock-hours countdown-time-value" style = "width: 75px;">
                            <div class="wrap">
                                    <div class="inner">
                                            <div id="canvas_hours" class="clock-canvas"></div>
                                            <div class="text" style="position: relative; top: 3px;">
                                                    <p class="val">0</p>
                                                    <p class="type-hours type-time"><?=$this->lang->line('HRS');?></p>
                                            </div>
                                    </div>
                            </div>
                    </div>
            ...
            <td style="width: 15px;"></td>
            <td>
                    <div class="clock-item clock-minutes countdown-time-value" style = "width: 75px;">
                            <div class="wrap">
                                    <div class="inner">
                                            <div id="canvas_minutes" class="clock-canvas"></div>
                                            <div class="text" style="position: relative; top: 3px;">
                                                    <p class="val">0</p>
                                                    <p class="type-minutes type-time"><?=$this->lang->line('MINS');?></p>
                                            </div>
                                    </div>
                            </div>
                    </div>
            ...
            <td style="width: 15px;"></td>
            <td id="seconds">
                    <div class="clock-item clock-seconds countdown-time-value"  style = "width: 75px;">
                            <div class="wrap">
                                    <div class="inner">
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script><script type="text/javascript" 
