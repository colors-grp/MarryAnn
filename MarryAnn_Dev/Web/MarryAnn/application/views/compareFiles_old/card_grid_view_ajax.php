		...
		<tr align="center">
			...
			<td>
				<div class="card-holder">
                    ...
                    <?php if ($score[$i-1] == -1){?>
                    	<img src = "<?=base_url()?>/h7-assets/resources/img/new_mark.png" class = "new-mark">
                    <?php }else{?>
                    	<img src = "<?=base_url()?>/h7-assets/resources/img/new_mark.png" class = "new-mark" style = "display: none;">
                    <?php }?>
				</div>
			</td>
			<?php }
                        //log_message('error','mo7eb card_grid_view_ajax $blocked_cards='.print_r($blocked_cards,TRUE));
                        foreach($blocked_cards as $card){
                            if ($i % 2 == 0) {
                                if ($i != 0) {?>
                                </tr>
                                <?php } ?>
                                        ...
                                        <td> 
                                                <div class="card-holder">
                                                        <img
                                                                ...
                                                                class="card-pic" alt="card" title="Not Available Yet!!" >
                                                          <?php 
                                                          	if($first_blocked_card == false){
														  ?>
														  		<div id = "card-counter">
                                                          ...
                                                          <?php
                                                          		$card_time = $card['start_date'];
                                                          		$first_blocked_card = true;
														  	}
                                                          ?>
                                                </div>
                                        </td>
