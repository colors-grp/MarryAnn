...
<div class="container" id="My-container" style="position: relative;top: 40px;">
    <div id="credit_descriptionn">
        <h1>Description</h1>
        <p>
            <B>Platform Name:</B>This Field is for your information.<B>(Like: web, ios, android, facebook or twitter)</B><br />
            <B>Day:</B>How many days players should sign in continuously to gain the daily credit.<B>(Like: 1, 2, 3, etc.)</B><br />
            <B>Daily Credit:</B>The amount of credit will be given to player in that day.<br /><br />
            <B>Add platform_credit (BUTTON):</B>Will auto add new day in all platforms with 0 daily credit.<br />
        </p>
    </div>
<!--	<div id="add_mcq">
