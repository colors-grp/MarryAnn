...
<script type="text/javascript">
	...
	function page_width(){
		...
		if (window.screen.availHeight > 700 && h < 600)
 		...
 		document.getElementById("done-content").style.marginTop = h * 0.066469 + "px";
...
<div id = "container">
	<div id = "form-info" style = "text-align: center;">
		<h3 id = "done-content" style = "color: red; font-family: Segoe UI;">السيلفى جاهز على بروفايلك</h3>
		<a class="btn btn-primary" href = "<?=base_url();?>index.php/fanos_selfie">اعمل سيلفى تانى</a>
		<a class="btn btn-danger" target="_blank" href = "http://facebook.com/<?php echo $_SESSION['fb_id']; ?>">روح بروفايلى</a>
	</div>
</div>
