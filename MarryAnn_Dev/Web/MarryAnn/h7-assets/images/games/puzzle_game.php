	...
	function initPuzzle()
	{
		...
		if(puzzleImages.length<=1) {
			...
			scramble();
                ...
                var ajaxpage = "<?= base_url()?>index.php?/game_center/get_best_score";
                $.post(ajaxpage , {})
                .done(function( data ) {
                    old_score = parseInt(data);
                });
	}
...
<div id = "puzzle_game" class="popup-container">
	...
	<div id="right-bar-view">
            ...
            <a  id="close-popup-button" href="javascript:void(0);" onclick="closeModal(<?=$cat_id?>); clear_intervals();"><img src="<?=base_url()?>h7-assets/resources/img/main-icons/close_window.png" style = "width: 20px;"></a>
