...
var TOKEN_PER_ROW = 7; // Rows
var TOKEN_PER_COL = 7; // Columns
var BOARD_WIDTH = CELL_SIZE * TOKEN_PER_ROW - SPACE; //Minus the space of last tokens
var BOARD_HEIGHT = CELL_SIZE * TOKEN_PER_COL - SPACE; //Minus the space of last tokens
var TOTAL_FRAME = 12; // Game Speed
var IMAGE_SET = (document.getElementById('base_url').innerHTML + "h7-assets/images/categories/sallySyamak/cards/"+ document.getElementById('card_id').innerHTML +"/game_images/elemental/");
...
function SunToken(){
	...
	this.explode = function(match, token, excludeList){
		...
		//Score += TOKEN_PER_ROW + TOKEN_PER_COL - 1;
		//alert(Score);
		//alert(TOTAL_FRAME);
		return TOTAL_FRAME;
	}
